<%@ Page Title="" Language="C#" MasterPageFile="~/user/after_login.master" AutoEventWireup="true" CodeFile="after_login.aspx.cs" Inherits="user_after_login" %>
					...
					<div class="wfilter_carousel m_bottom_30 m_xs_bottom_15">
						...
						<figure class="r_corners photoframe shadow relative tr_all_hover filter_class_featured animate_ftb long">
							...
							<a href="#" class="d_block relative pp_wrap">
                                ...
                                <asp:Image ID="Image1" runat="server" ImageUrl="~/user/images/man/d1.jpeg" class="tr_all_hover" Height="245" Width="220" />
								<%--<img src="images/anil.JPG" class="tr_all_hover" alt="" >--%>

								<span data-popup="#quick_view_product_all" class="button_type_5 box_s_none color_light r_corners tr_all_hover d_xs_none">Quick View</span>
						...
						<figure class="r_corners photoframe shadow relative tr_all_hover animate_ftb long filter_class_new">
							...
							<a href="#" class="d_block relative wrapper pp_wrap">
								...
								<asp:Image ID="Image2" runat="server" ImageUrl="~/user/images/man/HushBabies-coupons-Sprockets-and-YD-T-Shirts-Set-of-3.jpg" class="tr_all_hover" Height="245" Width="220" />
						...
						<figure class="r_corners photoframe shadow relative tr_all_hover animate_ftb long filter_class_specials">
							...
							<a href="#" class="d_block relative wrapper pp_wrap">
								...
								<asp:Image ID="Image3" runat="server" ImageUrl="~/user/images/man/jeans.jpg" class="tr_all_hover" Height="245" Width="220" />
						...
						<figure class="r_corners photoframe shadow relative animate_ftb long tr_all_hover filter_class_hit">
							...
							<a href="#" class="d_block relative pp_wrap">
								...
								<asp:Image ID="Image4" runat="server" ImageUrl="~/user/images/man/short.jpg" class="tr_all_hover" Height="245" Width="220" />
						...
						<figure class="r_corners photoframe shadow relative animate_ftb long tr_all_hover filter_class_rated">
							...
							<a href="#" class="d_block relative pp_wrap">
								...
								<asp:Image ID="Image5" runat="server" ImageUrl="~/user/images/anil.JPG" class="tr_all_hover" Height="245" Width="220" />
						...
						<figure class="r_corners photoframe shadow relative tr_all_hover animate_ftb long filter_class_featured">
							...
							<a href="#" class="d_block relative wrapper pp_wrap">
								...
								<span data-popup="#" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Quick View</span>
							...
							&nbsp;<!--description and price of product--><figcaption>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 m_sm_bottom_35 blog_animate animate_ftr">
							...
							<div class="blog_carousel">
								...
								<div class="clearfix">
									...
									&nbsp;<!--post content--><div class="mini_post_content">
							...
							<a href="#" class="d_block banner wrapper r_corners type_2 relative">
								...
								<span class="banner_caption d_block vc_child t_align_c w_sm_auto">
									...
									<span class="d_inline_middle">
										...
										<span class="d_block color_light tt_uppercase m_bottom_15 m_md_bottom_5 d_mxs_none">On All<br><b>Sunglasses</b></span><span class="button_type_6 bg_dark_color tt_uppercase r_corners color_light d_inline_b tr_all_hover box_s_none f_size_ex_large">Shop Now!</span>
