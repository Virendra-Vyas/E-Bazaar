<%@ Page Title="" Language="C#" MasterPageFile="~/seller/seller.master" AutoEventWireup="true" CodeFile="add_product.aspx.cs" Inherits="seller_add_product" %>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="product_images.aspx">
								<asp:Label ID="lbl_title_form" runat="server" Text="Add Product"></asp:Label>
							</a>
                        ...
                        <div class="portlet-body form">
							...
							<div class="form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div class="form-group ">
										        <asp:Label  class="control-label col-md-3" ID="lbl_company_menu" runat="server" Text="Company Menu"  Font-Size="12pt"> <asp:Label class="required" ID="Label16" runat="server" Text=" *"></asp:Label></asp:Label>
										    <div class="col-md-4">
                                                <asp:DropDownList ID="DropDownListcompany_menu" runat="server"  class="form-control"    Font-Size="15px" ForeColor="#666633"></asp:DropDownList>										    </div>
									</div>
                                    <div class="form-group ">
