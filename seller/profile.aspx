<%@ Page Title="" Language="C#" MasterPageFile="~/seller/seller.master" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="seller_profile" %>
								...
								<div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <ul class="list-unstyled profile-nav">
											<li>
                                                <asp:Image ID="adminprofile" runat="server" BorderColor="Black" Height="230px" Width="230px"  ImageUrl="~/images/product_se_images/11078008_361812314015239_89720656_n.jpg"/>
											</li>
										...
										<div class="row">
											<div class="col-md-8 profile-info">
                                                ...
                                                <ul class="list-inline">
													...
													<li>
														<i class="fa fa-briefcase"></i> <asp:Label ID="lblwork" runat="server" Text="Seller"></asp:Label>
													</li>
                                    ...
                                    <div class="col-md-9">
                                        <div class="tab-content">
											<div id="personal-info" class="tab-pane active">
													...
													<div class="form-group">
                                                        <asp:Label ID="lblfname" runat="server" Text="Frist Name :"  class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                        <asp:TextBox ID="txtfname" runat="server" placeholder="Sharma" class="form-control" ></asp:TextBox>
													</div>

                                                <div class="form-group">
                                                        <asp:Label ID="lblmname" runat="server" Text="Middle Name :"  class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                        <asp:TextBox ID="txtmname" runat="server" placeholder="Anil" class="form-control" ></asp:TextBox>
													</div>

                                                <div class="form-group">
                                                        <asp:Label ID="lbllname" runat="server" Text="Last Name :"  class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                        <asp:TextBox ID="txtlname" runat="server" placeholder="Ramkant" class="form-control" ></asp:TextBox>
													</div>

                                                <div class="form-group">
                                                        <asp:Label ID="lblmail" runat="server" Text="Email :"  class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                        <asp:TextBox ID="txtemail" runat="server" placeholder="Sharmaanil8866@gmail.com" class="form-control" TextMode="Email" ></asp:TextBox>
													</div>

                                                <div class="form-group">
                                                        <asp:Label ID="lblusername1" runat="server" Text="User Name :"  class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                        <asp:TextBox ID="txtusername" runat="server" placeholder="Sharmaanil" class="form-control" ></asp:TextBox>
													</div>

                                                <div class="form-group">
                                                        <asp:Label ID="lbldate" runat="server" Text="Date of Brith:"  class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                        <asp:TextBox ID="txtdate" runat="server" placeholder="29/10/1994" class="form-control" TextMode="Date" ></asp:TextBox>
                                                    
													</div>

                                                <div class="form-group">
                                                        <asp:Label ID="lbl_address" runat="server" Text="Address :"  class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                        <asp:TextBox ID="txtaddress" runat="server" placeholder="Ahmedabad" class="form-control" TextMode="MultiLine"></asp:TextBox>
													</div>

                                                <div class="form-group">
                                                        <asp:Label ID="lbl_number" runat="server" Text="Telephone No :"  class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
...
<!---------------------------------------------------------end-----------------------------------------------------------------------------
 <!----------------------------------------------------------start change-password---------------------------------------------------------->
                                            ...
                                            <div id="change-password" class="tab-pane">
												...
												<div class="form-group">
                                                    <asp:Label ID="lblcu_password" runat="server" Text="Current Password" class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                    <asp:TextBox ID="txtcu_password" runat="server" class="form-control" TextMode="Password"></asp:TextBox>
														
												</div>
                                                <div class="form-group">
                                                    <asp:Label ID="lblnew_password" runat="server" Text="New Password" class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
                                                    <asp:TextBox ID="txtnew_password" runat="server" class="form-control" TextMode="Password"></asp:TextBox>
														
												</div>	
                                                <div class="form-group">
                                                    <asp:Label ID="lblretype_password" runat="server" Text="Re-type New Password" class="control-label" Font-Bold="True" Font-Size="15px" ForeColor="#666666"></asp:Label>
