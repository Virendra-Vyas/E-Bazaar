...
public partial class seller_add_product : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        add_data.product_main_image = image.FileName;
    ...
    public void company_menu_bind()
    {
        List<menu_category_model> li = menu_category_repository.select_all();
        DropDownListcompany_menu.DataSource = li;
        DropDownListcompany_menu.DataTextField = "menu_category_name";
        DropDownListcompany_menu.DataValueField = "menu_category_id";
        DropDownListcompany_menu.DataBind();
    }
}