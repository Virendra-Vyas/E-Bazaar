<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="page_category.aspx.cs" Inherits="admin_page_category" %>
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="page_category.aspx">
								<asp:Label ID="lbl_title_category" runat="server" Text="Categroy"></asp:Label>
							</a>
						</li>
					</ul>
							...
							<div class="form-horizontal">
								...
								<div class="form-body">
                                    <div class="form-group">
                                                    <asp:Label ID="lblmenu_name" runat="server" Text=" Menu Name" class="col-md-3 control-label"  Font-Size="12pt">
                                                        
													</asp:Label>
													<div class="col-md-4">
                                                        <asp:DropDownList ID="DropDownListmenu_name" runat="server" class="form-control"  Font-Size="15px" ForeColor="#666633" ></asp:DropDownList>
                                    ...
                                    <div class="form-group">
													...
													<div class="col-md-4">
													    <asp:TextBox ID="txtname"  class="form-control" placeholder=" menu Category Name" runat="server"></asp:TextBox>
                                     ...
                                     <div class="form-group">
													...
													<div class="col-md-4">
															 ...
															 <asp:DropDownList  class="form-control"  ID="DropDownList_category" runat="server"  Font-Size="15px" ForeColor="#666633">
                                                             <asp:ListItem>Visible-Category</asp:ListItem>
