...
<head>
<meta >
<title>window shopping|Admin-login</title>
...
<div class="content">
	...
	<form id="Form1" class="login-form" runat="server" >
		...
		<div class="form-actions">
            ...
            <asp:LinkButton ID="btn_login" runat="server"  class="btn blue pull-right " OnClick="btn_login_Click" >Login<i class="m-icon-swapright m-icon-white"></i></asp:LinkButton>		
            <%--<asp:Button ID="btn_login" runat="server" Text="Login" class="btn blue pull-right " OnClick="btn_login_Click1" />--%>
		</div>
...
<script src="assets/scripts/custom/login-soft.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
