<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="update_menu_category.aspx.cs" Inherits="admin_update_menu_category" %>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
                            <div class="caption">
								<asp:Label ID="Label5" runat="server" Text="Update Information Menu Category"></asp:Label>
							</div>
                            <div class="tools">
