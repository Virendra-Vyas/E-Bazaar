<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_datatable_list.master" AutoEventWireup="true" CodeFile="datatable_wishlist.aspx.cs" Inherits="admin_datatable_wishlist" %>
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="datatable_wishlist.aspx">
                                    <asp:Label ID="lbl_title_wishlist" runat="server" Text="Wish List"></asp:Label>
                                </a>
				...
				<div class="col-md-12">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
								<asp:Repeater runat="server" ID="wish_List" OnItemCommand="wish_List_ItemCommand">
                                    <HeaderTemplate>
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="success"><asp:Label ID="lblwish_id" runat="server" Text="Wish Id" Font-Bold="true" ForeColor="black" Font-Size="15px"></asp:Label></th>
                                                    ...
                                                    <th class="success"><asp:Label ID="lbluser_name" runat="server" Text="User Name" Font-Bold="true" ForeColor="black" Font-Size="15px"></asp:Label></th>
                                                    <th 
