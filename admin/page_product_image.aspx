<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="page_product_image.aspx.cs" Inherits="admin_page_product_image" %>
			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							<a href="#">
								<asp:Label ID="lbl_title_multi_menu" runat="server" Text="Product Details"></asp:Label>
							</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
							<a href="page_product_image.aspx">
