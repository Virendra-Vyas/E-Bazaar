<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_datatable_list.master" AutoEventWireup="true" CodeFile="datatable_company_list.aspx.cs" Inherits="admin_datatable_company_list" %>
            ...
            <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="data_table_company_list.aspx">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:LinkButton ID="btn_delete"   runat="server" class="btn red" OnClientClick="return confirm('Are you sure, you want to delete this record?');" CommandName="delete" CommandArgument='<%# Eval("company_id") %>' > <i class="fa fa-trash-o"></i> Delete</asp:LinkButton>
